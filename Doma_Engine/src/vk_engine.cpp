...
void VulkanEngine::init_sync_structures() {
    ...
    //we want the fence to start singalled so we can wait on it on the first frame
...
void VulkanEngine::create_swapchain(uint32_t width, uint32_t height) {
    ...
    vkb::Swapchain vkbSwapchain = swapchainBuilder
        ...
        .set_desired_present_mode(VK_PRESENT_MODE_FIFO_KHR) // can change to mailbox mode for real world usage.
...
void VulkanEngine::init_swapchain() {
    ...
    //hardcoding the draw format to 32 bit flat
